...
<img width="1536" height="1024" alt="Architecture1" src="https://github.com/user-attachments/assets/b01d45af-0196-40c6-ace0-659fb014129a" />
...
* Configurable catalog parameter
  <img width="1918" height="887" alt="image" src="https://github.com/user-attachments/assets/67f62246-78ae-4faa-938a-2e4f8620694a" />
...
* **Streaming Table** (`earthquake_data_final`): Deduplicates by `id` using SCD Type 1 CDC pattern
  <img width="1918" height="876" alt="Screenshot 2026-07-08 161613" src="https://github.com/user-attachments/assets/7ba149fb-c0ad-41a0-abe3-7c61d48a9a41" />


### 3. **Dashboard** (`Data1_Earthquake_Dashboard`)
* Visualizes earthquake metrics and trends
* Connected to Silver layer table
  <img width="1918" height="908" alt="Screenshot 2026-07-08 163309" src="https://github.com/user-attachments/assets/bdf951dc-027e-45f3-9551-103df0f00aaa" />
